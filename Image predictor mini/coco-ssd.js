...
!function(e, a) {
  ...
  function n(e, a, i, n) {
    return new(i || (i = Promise))((function(t, m) {
      ...
      function o(e) {
        var a;
        e.done ? t(e.value) : (a = e.value, a instanceof i ? a : new i((function(e) {
          e(a)
        }))).then(d, s)
      }
          ...
          for (; d;) try {
            ...
            switch (n = 0, t && (m = [2 & m[0], t.value]), m[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(t = d.trys, (t = t.length > 0 && t[t.length - 1]) || 6 !== m[0] && 2 !== m[0])) {
                  d = 0;
                  continue
                }
  ...
  var d = function() {
    function e(e, a) {
      this.modelPath = '/model.json'//"".concat("https://storage.googleapis.com/tfjs-models/savedmodel/").concat(this.getPrefix(e), "/model.json")
    }
    return e.prototype.getPrefix = function(e) {
      ...
      for (var s = t.length, o = [], r = 0; r < s; r++) {
        ...
        var c = l[0] * a,
          ...
          u = l[2] * a,
          f = l[3] * e;
        l[0] = y, l[1] = c, l[2] = f - y, l[3] = u - c, o.push({
          bbox: l,
      ...
      for (var n = [], t = [], m = 0; m < a; m++) {
        for (var d = Number.MIN_VALUE, s = -1, o = 0; o < i; o++) e[m * i + o] > d && (d = e[m * i + o], s = o);
        n[m] = d, t[m] = s
      }
      return [n, t]
